...
trait SaxParseErrorRegExConstants {
  ...
  final val missingTagDocSpecErrorFormat =
    """cvc-complex-type.2.4.a: Invalid content was found starting with element '(?:.*:)?(.*?)'. One of '"urn:oecd:ties:cbcstf:v5":(?:.*:)?(.*?)' is expected.""".stripMargin.r
