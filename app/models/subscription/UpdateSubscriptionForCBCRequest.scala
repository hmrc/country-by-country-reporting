...
object UpdateSubscriptionForCBCRequest {
  ...
  def apply(requestDetail: RequestDetailForUpdate): UpdateSubscriptionForCBCRequest =
    UpdateSubscriptionForCBCRequest(UpdateSubscriptionDetails(RequestCommonForUpdate("CBC"), requestDetail))
}
