...
class AgentSubscriptionRequestSpec extends AnyFreeSpec with Generators with OptionValues with Matchers {
  ...
  "AgentSubscriptionRequest" - {
    "must serialise and de-serialise as expected" in {
      ...
      Json
        .toJson(requestModel)
        .as[AgentSubscriptionEtmpRequest] mustBe requestModel
